...
public class PlayerSelectionView implements IObservable<StartMessage> {
    ...
    public PlayerSelectionView(ArrayList<Adventurer> adv, int nbAdv,IObserver<StartMessage> o) {
        ...
        for (Adventurer adventurer : adventurers) {
            ...
            if (img != null) {
                selectedIco.add(img);
                ImageIcon icon = new ImageIcon(img.getScaledInstance(img.getWidth() , img.getHeight() , Image.SCALE_SMOOTH));
