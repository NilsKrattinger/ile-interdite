...
public class TreasureView {
    ...
    public TreasureView(ArrayList<Treasure> treasures) {
        ...
        ArrayList<Treasure> treasureList = new ArrayList<>(treasures);
        SwingUtilities.invokeLater(() -> {
            ...
            final int width = totalWidth + treasureList.size() * 10; // Add a little space between treasures
    ...
    public void collectTreasure(Treasure t) {
        SwingUtilities.invokeLater(() -> components.get(t).setCollected());
    }
